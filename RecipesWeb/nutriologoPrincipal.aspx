<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nutriologoPrincipal.aspx.cs" Inherits="RecipesWeb.nutriologoPrincipal" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <h1>Tu cuenta</h1>
                ...
                <asp:Label ID="lbCedula" runat="server" ForeColor="#FF6A6A"></asp:Label>  
                <br />
                <br />
            ...
            <div class="seccionContrasena">
                ...
                <br />
                <asp:Button ID="btnSalir" runat="server" BackColor="#829949" BorderWidth="4px" border-radius="6px" ForeColor="White" Height="50px" font-size="18px" font="sans-serif" Text="Cerrar Sesión" CssClass="button" OnClick="btnSalir_Click" />
            <footer>
